...
The project is completely open source, if you wanna use kike devolper , i recommended yo should be opened with the Xcode 13 or newer.
Dependencies are managed with [Swift Package Manager](https://swift.org/package-manager), no further setup is needed.
But thw user (you) can make the app and edit using the way you prefer! I dont know if others way the app will be like thw first veesion (my vwrsion), but if you really can do that, I hope you share the app free for other people!
